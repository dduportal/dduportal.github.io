(function() {
  ...
  Ruban = (function() {
    ...
    Ruban.prototype.initOptions = function() {
      ...
      return (_base6 = this.options).bindMouseWheel != null ? _base6.bindMouseWheel : _base6.bindMouseWheel = false;
    };
    ...
    Ruban.prototype.bindClicks = function() {
      ...
      return this.$ruban.mousedown((function(_this) {
        return function(e) {
          switch (e.which) {
            case 1:
              return _this.next();
    ...
    Ruban.prototype.bindMouseWheel = function() {
      return this.$ruban.on('wheel', (function(_this) {
        return function(e) {
